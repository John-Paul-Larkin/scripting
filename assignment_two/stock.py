...
def main():
    ...
    # # wite all stock data to a text file
    # with open('stock_data.txt', 'w') as f:
    #     f.write(str(all_stock_data))
    
    print("Starting database update...")
    update_stock_db(stock_data) 
    # verify_db_contents()
    
    # campany_headlines = get_yahoo_headlines(COMPANIES)
    # for company_name, headlines in campany_headlines.items():
    #     print(f"\n{company_name} Headlines:")
